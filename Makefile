#############################################################################
# Makefile for building: KaKaCoin-Qt.app/Contents/MacOS/KaKaCoin-Qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sat Feb 1 23:56:05 2014
# Project:  kakacoin-qt.pro
# Template: app
# Command: /usr/local/bin/qmake USE_UPNP= -o Makefile kakacoin-qt.pro
#############################################################################
...
CC            = /usr/bin/clang
CXX           = /usr/bin/clang++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DMAC_OSX -DMSG_NOSIGNAL=0 -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
DIST          = /opt/local/share/qt4/mkspecs/common/unix.conf \
		...
		kakacoin-qt.pro
QMAKE_TARGET  = KaKaCoin-Qt
DESTDIR       = 
TARGET        = KaKaCoin-Qt.app/Contents/MacOS/KaKaCoin-Qt
...
all: Makefile KaKaCoin-Qt.app/Contents/PkgInfo KaKaCoin-Qt.app/Contents/Resources/empty.lproj KaKaCoin-Qt.app/Contents/Info.plist KaKaCoin-Qt.app/Contents/Resources/kakacoin.icns $(TARGET)

$(TARGET): /Users/tamvo/code/test/kakacoin/src/leveldb/libleveldb.a /Users/tamvo/code/test/kakacoin/build/build.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) KaKaCoin-Qt.app/Contents/MacOS/ || $(MKDIR) KaKaCoin-Qt.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: kakacoin-qt.pro  /opt/local/share/qt4/mkspecs/macx-g++/qmake.conf /opt/local/share/qt4/mkspecs/common/unix.conf \
		/opt/local/share/qt4/mkspecs/common/mac.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base-macx.conf \
		/opt/local/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP= -o Makefile kakacoin-qt.pro
...
KaKaCoin-Qt.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) KaKaCoin-Qt.app/Contents || $(MKDIR) KaKaCoin-Qt.app/Contents 
	@$(DEL_FILE) KaKaCoin-Qt.app/Contents/PkgInfo
	@echo "APPL????" >KaKaCoin-Qt.app/Contents/PkgInfo
KaKaCoin-Qt.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) KaKaCoin-Qt.app/Contents/Resources || $(MKDIR) KaKaCoin-Qt.app/Contents/Resources 
	@touch KaKaCoin-Qt.app/Contents/Resources/empty.lproj
	
KaKaCoin-Qt.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) KaKaCoin-Qt.app/Contents || $(MKDIR) KaKaCoin-Qt.app/Contents 
	@$(DEL_FILE) KaKaCoin-Qt.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,kakacoin.icns,g" -e "s,@EXECUTABLE@,KaKaCoin-Qt,g" -e "s,@TYPEINFO@,????,g" share/qt/Info.plist >KaKaCoin-Qt.app/Contents/Info.plist
KaKaCoin-Qt.app/Contents/Resources/kakacoin.icns: src/qt/res/icons/kakacoin.icns
	@$(CHK_DIR_EXISTS) KaKaCoin-Qt.app/Contents/Resources/ || $(MKDIR) KaKaCoin-Qt.app/Contents/Resources/ 
	@$(DEL_FILE) KaKaCoin-Qt.app/Contents/Resources/kakacoin.icns
	@$(COPY_FILE) src/qt/res/icons/kakacoin.icns KaKaCoin-Qt.app/Contents/Resources/kakacoin.icns
dist: 
	@$(CHK_DIR_EXISTS) build/KaKaCoin-Qt1.0.0.1 || $(MKDIR) build/KaKaCoin-Qt1.0.0.1 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/KaKaCoin-Qt1.0.0.1/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/KaKaCoin-Qt1.0.0.1/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm src/qt/macnotificationhandler.mm build/KaKaCoin-Qt1.0.0.1/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/scrypt.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/macnotificationhandler.h src/qt/splashscreen.h src/qt/macdockiconhandler.h src/qt/macnotificationhandler.h build/KaKaCoin-Qt1.0.0.1/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/KaKaCoin-Qt1.0.0.1/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/scrypt.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp build/KaKaCoin-Qt1.0.0.1/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm src/qt/macnotificationhandler.mm build/KaKaCoin-Qt1.0.0.1/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui build/KaKaCoin-Qt1.0.0.1/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/KaKaCoin-Qt1.0.0.1/ && (cd `dirname build/KaKaCoin-Qt1.0.0.1` && $(TAR) KaKaCoin-Qt1.0.0.1.tar KaKaCoin-Qt1.0.0.1 && $(COMPRESS) KaKaCoin-Qt1.0.0.1.tar) && $(MOVE) `dirname build/KaKaCoin-Qt1.0.0.1`/KaKaCoin-Qt1.0.0.1.tar.gz . && $(DEL_FILE) -r build/KaKaCoin-Qt1.0.0.1


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /Users/tamvo/code/test/kakacoin/src/leveldb/libleveldb.a; cd /Users/tamvo/code/test/kakacoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
distclean: clean
	-$(DEL_FILE) -r KaKaCoin-Qt.app
	-$(DEL_FILE) Makefile


/Users/tamvo/code/test/kakacoin/src/leveldb/libleveldb.a: FORCE
	cd /Users/tamvo/code/test/kakacoin/src/leveldb && CC=/usr/bin/clang CXX=/usr/bin/clang++ $(MAKE) OPT="-pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/Users/tamvo/code/test/kakacoin/build/build.h: FORCE
	cd /Users/tamvo/code/test/kakacoin; /bin/sh share/genbuild.sh /Users/tamvo/code/test/kakacoin/build/build.h
